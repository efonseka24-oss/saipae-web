...
import { moverPregunta } from "@/lib/ordenPanel";
...
async function manejarPOST(request: NextRequest, ctx: RouteContext<"/api/preguntas/[id]/mover">) {
  ...
  const movido = await moverPregunta(id, direccion);
